...
export type SubscriptionCategory = 'Cloud & Hosting' | 'Analytics & Monitoring' | 'AI Tools & LLMs' | 'Database & Storage' | 'Developer Tools' | 'Communication' | 'Design & Creative' | 'Marketing & SEO' | 'Security' | 'Media & Content' | 'Productivity' | 'Financial & Accounting' | 'CRM & Sales' | 'Legal & Compliance' | 'Other'
...
export interface SubscriptionWithProjects extends Subscription {
  projects: Array<{ 
    id: string
    name: string
    color: string | null
  ...
  public: {
    Tables: {
      ...
      subscription_projects: {
        ...
        Relationships: [
          {
            foreignKeyName: "subscription_projects_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "subscription_projects_subscription_id_fkey"
